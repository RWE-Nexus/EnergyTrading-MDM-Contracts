namespace RWEST.Nexus.MDM.Contracts
{
    ...
    public class PartyRoleAccountability : IMdmEntity
    {
        public PartyRoleAccountability()
        {
            this.Identifiers = new NexusIdList();
            this.Details = new PartyRoleAccountabilityDetails();
        ...
        [DataMember(Order = 2)]
        [XmlElement]
        public PartyRoleAccountabilityDetails Details { get; set; }
        ...
        object IMdmEntity.Details
        {
            ...
            set { this.Details = (PartyRoleAccountabilityDetails)value; }
        }
    }
}
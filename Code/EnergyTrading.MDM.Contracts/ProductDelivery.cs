namespace RWEST.Nexus.MDM.Contracts
{
    ...
    public class ProductDelivery : IMdmEntity
    {
        public ProductDelivery()
        {
            this.Identifiers = new NexusIdList();
            this.Details = new ProductDeliveryDetails();
        ...
        [DataMember(Order = 2)]
        [XmlElement]
        public ProductDeliveryDetails Details { get; set; }
        ...
        object IMdmEntity.Details
        {
            ...
            set { this.Details = (ProductDeliveryDetails)value; }
        }
    }
}
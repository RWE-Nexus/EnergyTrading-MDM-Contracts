namespace RWEST.Nexus.MDM.Contracts
{
    ...
    public class BookDefault : IMdmEntity
    {
        public BookDefault()
        {
            this.Identifiers = new NexusIdList();
            this.Details = new BookDefaultDetails();
        ...
        [DataMember(Order = 2)]
        [XmlElement]
        public BookDefaultDetails Details { get; set; }
        ...
        object IMdmEntity.Details
        {
            ...
            set { this.Details = (BookDefaultDetails)value; }
        }
    }
}
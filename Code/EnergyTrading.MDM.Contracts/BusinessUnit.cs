namespace RWEST.Nexus.MDM.Contracts
{
    ...
    public class BusinessUnit : IMdmEntity
    {
        public BusinessUnit()
        {
            this.Identifiers = new NexusIdList();
            this.Details = new BusinessUnitDetails();
        ...
        [DataMember(Order = 2)]
        [XmlElement]
        public BusinessUnitDetails Details { get; set; }
        ...
        object IMdmEntity.Details
        {
            ...
            set { this.Details = (BusinessUnitDetails)value; }
        }
    }
}
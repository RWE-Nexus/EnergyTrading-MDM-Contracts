namespace RWEST.Nexus.MDM.Contracts
{
    ...
    public class ShipperCode : IMdmEntity
    {
        public ShipperCode()
        {
            this.Identifiers = new NexusIdList();
            this.Details = new ShipperCodeDetails();
        ...
        [DataMember(Order = 2)]
        [XmlElement]
        public ShipperCodeDetails Details { get; set; }
        ...
        object IMdmEntity.Details
        {
            ...
            set { this.Details = (ShipperCodeDetails)value; }
        }
    }
}

namespace RWEST.Nexus.MDM.Contracts
{
    ...
    public class Counterparty : IMdmEntity
    {
        public Counterparty()
        {
            this.Identifiers = new NexusIdList();
            this.Details = new CounterpartyDetails();
        ...
        [DataMember(Order = 2)]
        [XmlElement]
        public CounterpartyDetails Details { get; set; }
        ...
        object IMdmEntity.Details
        {
            ...
            set { this.Details = (CounterpartyDetails)value; }
        }
    }
}
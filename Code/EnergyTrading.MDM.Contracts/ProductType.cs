namespace RWEST.Nexus.MDM.Contracts
{
    ...
    public class ProductType : IMdmEntity
    {
        public ProductType()
        {
            this.Identifiers = new NexusIdList();
            this.Details = new ProductTypeDetails();
        ...
        [DataMember(Order = 2)]
        [XmlElement]
        public ProductTypeDetails Details { get; set; }
        ...
        object IMdmEntity.Details
        {
            ...
            set { this.Details = (ProductTypeDetails)value; }
        }
    }
}
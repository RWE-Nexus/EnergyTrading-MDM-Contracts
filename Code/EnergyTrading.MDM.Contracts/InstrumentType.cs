namespace RWEST.Nexus.MDM.Contracts
{
    ...
    public class InstrumentType : IMdmEntity
    {
        public InstrumentType()
        {
            this.Identifiers = new NexusIdList();
            this.Details = new InstrumentTypeDetails();
        ...
        [DataMember(Order = 2)]
        [XmlElement]
        public InstrumentTypeDetails Details { get; set; }
        ...
        object IMdmEntity.Details
        {
            ...
            set { this.Details = (InstrumentTypeDetails)value; }
        }
    }
}

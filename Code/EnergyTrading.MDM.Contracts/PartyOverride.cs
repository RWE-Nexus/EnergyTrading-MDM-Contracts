namespace RWEST.Nexus.MDM.Contracts
{
    ...
    public class PartyOverride : IMdmEntity
    {
        public PartyOverride()
        {
            this.Identifiers = new NexusIdList();
            this.Details = new PartyOverrideDetails();
        ...
        [DataMember(Order = 2)]
        [XmlElement]
        public PartyOverrideDetails Details { get; set; }
        ...
        object IMdmEntity.Details
        {
            ...
            set { this.Details = (PartyOverrideDetails)value; }
        } 
    }
}
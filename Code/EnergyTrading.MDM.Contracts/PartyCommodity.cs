namespace RWEST.Nexus.MDM.Contracts
{
    ...
    public class PartyCommodity : IMdmEntity
    {
        public PartyCommodity()
        {
            this.Identifiers = new NexusIdList();
            this.Details = new PartyCommodityDetails();
        ...
        [DataMember(Order = 2)]
        [XmlElement]
        public PartyCommodityDetails Details { get; set; }
        ...
        object IMdmEntity.Details
        {
            ...
            set { this.Details = (PartyCommodityDetails)value; }
        }
    }
}
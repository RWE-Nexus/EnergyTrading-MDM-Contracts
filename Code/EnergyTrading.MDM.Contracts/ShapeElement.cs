namespace RWEST.Nexus.MDM.Contracts
{
    ...
    public class ShapeElement : IMdmEntity
    {
        public ShapeElement()
        {
            this.Identifiers = new NexusIdList();
            this.Details = new ShapeElementDetails();
        ...
        [DataMember(Order = 2)]
        [XmlElement]
        public ShapeElementDetails Details { get; set; }
        ...
        object IMdmEntity.Details
        {
            ...
            set { this.Details = (ShapeElementDetails)value; }
        }
    }
}
namespace RWEST.Nexus.MDM.Contracts
{
    ...
    public class ProductCurve : IMdmEntity
    {
        public ProductCurve()
        {
            this.Identifiers = new NexusIdList();
            this.Details = new ProductCurveDetails();
        ...
        [DataMember(Order = 2)]
        [XmlElement]
        public ProductCurveDetails Details { get; set; }
        ...
        object IMdmEntity.Details
        {
            ...
            set { this.Details = (ProductCurveDetails)value; }
        }
    }
}
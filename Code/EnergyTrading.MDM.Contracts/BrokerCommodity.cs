namespace RWEST.Nexus.MDM.Contracts
{
    ...
    public class BrokerCommodity : IMdmEntity
    {
        public BrokerCommodity()
        {
            this.Identifiers = new NexusIdList();
            this.Details = new BrokerCommodityDetails();
        ...
        [DataMember(Order = 2)]
        [XmlElement]
        public BrokerCommodityDetails Details { get; set; }
        ...
        object IMdmEntity.Details
        {
            ...
            set { this.Details = (BrokerCommodityDetails)value; }
        }
    }
}